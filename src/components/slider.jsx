function Featured(){
    return <section class="text-gray-600 bg-pbgcolor px-10">
  <div class="md:px-32 md:py-10 mx-auto">
    <div class="flex flex-col text-center w-full py-10">
      <h1 class="sm:text-3xl text-2xl font-menu font-semibold title-font text-gray-900">Featured Universities</h1>
    </div>
