...
function Team() {
  return (
    <div className="flex md:gap-x-15 gap-x-10  gap-y-10 flex-wrap justify-center bg-gray-300 md:h-full py-15">
      <div className="flex flex-col text-center w-full">
        <h1 className="sm:text-3xl text-2xl font-semibold title-font text-gray-900 font-menu">
          Team Members
        </h1>
      </div>
